...
{
    $otpVerification = App\Models\Preference::where(['category' => 'preference', 'field' => 'verification_otp'])->first(['value'])->value;
...
function isMiningReferralEnabled() 
{
    $isMiningReferralEnabled = \App\Models\Setting::where(['name' => 'is_referral_enabled', 'type' => 'referral'])->first(['value'])->value;
    return $isMiningReferralEnabled;
}