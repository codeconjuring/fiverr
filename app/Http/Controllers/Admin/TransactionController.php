    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->type == 'Voucher Created') {
            if ($request->status == 'Blocked') {
                ...
                $this->helper->one_time_message('error', 'You cannot Changed into this status');
                return redirect('admin/transactions');
            ...
            if ($request->status == 'Blocked') {
                if ($t->status == 'Success') //current status
                {
                    ...
                    if (isset($voucher_email_temp)) {
                        ...
                        $t_pending_msg = str_replace('{status}', $request->status, $t_pending_msg);
