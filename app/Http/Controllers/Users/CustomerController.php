...
use App\Models\Wallet;use App\Repositories\CryptoCurrencyRepository;use Exception;use Illuminate\Http\Request;
...
class CustomerController extends Controller
{
    ...
    public function profile()
    {
        ...
        return view('user_dashboard.users.new_profile', $data);
    }
