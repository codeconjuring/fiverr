                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td class="text-center text-muted" colspan="2">
                                ...
                                |
                                <a class="text-muted" href="{{ url('transactions') }}">
                                    Transaction
                                    Histories
                                </a>
                            </td>
                        ...
                        if (json.data.error == 'ok') {
                            ...
                            axios.post(`{{ route('coinpayment.ajax.trxinfo') }}`, parameters)
                                .then(function (response) {
                                    ...
                                    var params = {
                                          txn_id: jsonData.result.txn_id,
                                          _token: "{{csrf_token()}}"
                                    };
                                    axios.post(`{{route('coinpayment.success.transactioninfo') }}`, params)
                                      .then(function (json) {
                                        _self.payment.last = json.data;
                                        var date = new Date(json.data.time_expires * 1000);
                                ...
                                .catch(function (error) {
                                    console.log(error);
                                    swal('Dangerdsfds!', 'Look like something wrong!');
                                });
