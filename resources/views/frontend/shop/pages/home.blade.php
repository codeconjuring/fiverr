                                                    ...
                                                    <li>
                                                        <span class="catagori-item-menu-image">
                                                            @if(!empty($productCategory->photo))
                                                                <img src="{{ url('public/images/shop/product_category/' . $productCategory->photo)}}" alt="nav-cat">
                                                            @else
                                                                <img src="{{ url('public/dist/img/shop/product_category.png') }}">
                                                            @endif
                                                        </span>
                                                        <a href="{{ url('shop/product-categories/' . $productCategory->id) }}"> {{ $productCategory->name }}</a>
                                                    </li>
                                                <?php
                                            }
                                            else
