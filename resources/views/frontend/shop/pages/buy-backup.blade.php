                ...
                <div class="card">
                    ...
                    <div class="wap-wed mb20 p-4 cart-details">
                        ...
                        <div class="row mt20">
                            ...
                            <div class="col-6 text-right"><strong>{{ $product->title }}</strong></div>
                        </div>
                        
                        <div class="row mt10">
                            <div class="col-6">Product Code</div>
                            <div class="col-6 text-right"><strong>#{{ $product->product_code }}</strong></div>
                        </div>
                        
                        
                        <div class="row">
                            <div class="col-6 h6">Product Price</div>
                            <div class="col-6 text-right"><strong>{{ moneyFormat($product->currency->symbol, $product->price) }}</strong></div>
                        </div>
                    </div>
