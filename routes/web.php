...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin', 'middleware' => ['guest:admin', 'locale']], function () {
    ...
    Route::post('stores/update-store-code-check', 'StoreController@checkStoreCode');
...
Route::group(['middleware' => ['guest:users', 'locale', 'twoFa', 'check-user-inactive'], 'namespace' => 'Users'], function () {
    ...
    Route::group(['middleware' => ['permission:manage_deposit', 'check-user-suspended']], function () {
        ...
        // CIB
        Route::get('deposit/cib-deposit-store', 'DepositController@cibDepositStore');
        Route::get('deposit/cib-deposit-success', 'DepositController@cibDepositSuccess')->name('deposit.cib.success');

        // CIB
        Route::get('deposit/dahabia-deposit-store', 'DepositController@dahabiaDepositStore');
        Route::get('deposit/dahabia-deposit-success', 'DepositController@dahabiaDepositSuccess')->name('deposit.dahabia.success');
    ...
    Route::group(['middleware' => ['permission:manage_voucher']], function () {
        ...
        Route::post('voucher/generate-voucher-activation-qr-code', 'VoucherController@generateVoucherActivationQrCode');
    ...
    Route::group(['middleware' => ['permission:manage_product_category']], function () {
        ...
        Route::post('product-categories/update', 'ProductCategoryController@update');
        // Route::post('product-categories/delete', 'ProductCategoryController@destroy');
        Route::post('product-categories/delete-product-categories-photo', 'ProductCategoryController@deleteProductCategoryPhoto');
    });
    ...
    Route::group(['middleware' => ['permission:manage_product']], function () {
        ...
        Route::post('/product/delete-product-photo', 'ProductController@deleteProductPhoto');
        Route::post('products/product-code-check', 'ProductController@checkProductCode');
        Route::post('products/product-code-check-update', 'ProductController@checkProductCodeUpdate');
        Route::post('products/get-product-categories', 'ProductController@getCategoriesByStore');
    });

    Route::match(array('GET', 'POST'), 'shipping-address', 'ShippingAddressController@addShippingAddress');

    Route::get('customer-orders', 'OrderController@customersOrders');
    Route::get('owner-orders', 'OrderController@ownerOrders');
    Route::get('shipping-address/{id}', 'ShippingAddressController@customerShippingAddress');
...
// Shop frontend
Route::get('shop', 'Users\Shop\ShopController@index');
Route::any('shop/search', 'Users\Shop\ShopController@defaultSearch');
Route::get('shop/product-categories/{id}', 'Users\Shop\ShopController@defaultCategoryProducts');

Route::get('shop/product/confirm/{id}', 'Users\Shop\ProductController@buyConfirm');
Route::get('shop/product/buy/{id}', 'Users\Shop\ProductController@buy');
Route::get('shop/product/{id}', 'Users\Shop\ProductController@show');

Route::get('shop/{id}/{name}', 'Users\Shop\SpecificStoreController@index');
Route::get('shop/{name}/{store_id}/{category_id}', 'Users\Shop\SpecificStoreController@storeCategoryProducts');
