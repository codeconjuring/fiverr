...
<div class="shop-page-wrapper mt-3">
            ...
            <div class="col-md-3 pr-md-0">
                                                ...
                                                <li>
                                                    <span class="catagori-item-menu-image">
                                                        @if(!empty($productCategory->photo))
                                                            <a href="{{ url('shop/'.$productCategory->store->slug.'/'.$productCategory->store_id.'/'. $productCategory->id) }}"><img src="{{ url('public/images/shop/product_category/' . $productCategory->photo)}}" alt="nav-cat"></a>
                                                        @else
                                                            <a href="{{ url('shop/'.$productCategory->store->slug.'/'.$productCategory->store_id.'/'. $productCategory->id) }}"><img src="{{ url('public/dist/img/shop/product_category.png') }}"></a>    
                                                        @endif
                                                    </span>
                                                    <a href="{{ url('shop/'.$productCategory->store->slug.'/'.$productCategory->store_id.'/'. $productCategory->id) }}"> {{ $productCategory->name }}</a>
                                                </li>
                                                <?php
                                            }
                                            else
                ...
                <div class="col-md-9 pl-md-0">
                    ...
                    <div class="shop-main-display-image pl-md-2 pt-2">
                        @if($store->photo)
                            <img src="{{ url('public/images/shop/store/' . $store->photo) }}" alt="">
                        @else
    ...
    <div class="shop-page-product-area">
        <div class="container">
            <div class="product-area-heading mb-4 d-flex justify-content-between">
                <h1>Product</h1>
                <marquee><h1 class="product-sub-headding text-danger">{{ $store->name }}</h1></marquee>
            </div>
            <div class="row">
