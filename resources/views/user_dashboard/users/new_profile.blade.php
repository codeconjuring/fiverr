...
<li class="breadcrumb-item active"><a href="javascript:void(0)">@lang('message.dashboard.setting.title')</a></li>
</ol>
</div>
<!-- row -->
<div class="row">
...
<div class="card-body">
  <div class="profile-statistics mb-5">
    <div class="text-center">
      <div class="row">
        <div class="col-md-6 col-xl-6 col-sm-6 col-6 offset-3">
    ...
    <div class="mt-4">
        <button type="button" class="btn btn-primary mb-1 mr-1 update-qr-code" id="qr-code-btn">
            @lang('message.dashboard.button.update-qr-code')
        </button>

        <a href="#" class="btn btn-primary mb-1" id="print-qr-code-btn" style="display: none;width: 158px;">
            <strong>
                Print QR Code
            </strong>
        </a>
