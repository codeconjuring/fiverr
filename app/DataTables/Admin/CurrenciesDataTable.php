...
class CurrenciesDataTable extends DataTable
{
    ...
    {
        $query = Currency::select('id','type','name','code','number','symbol','rate','logo','status','default')->orderBy('id', 'desc');
    ...
    public function html()
    {
        ...
        ->addColumn(['data' => 'number', 'name' => 'currencies.number', 'title' => 'Number'])
