            ...
            <div class="collapse navbar-collapse navbar-toggler-right" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto d-lg-none">
                    ...
                    @if(Common::has_permission(auth()->id(),'manage_store'))
                        <li class="nav-item"><a href="{{url('/stores')}}" class="nav-link">Shop</a></li>
                    @endif
                    ...
                    @if($isMiningReferralEnabled == 'yes')
                        <li class="<?= isset($menu) && ($menu == 'refer') ? 'active' : '' ?>">
                            <a href="{{url('/refer-friend')}}"><i class="fa fa-user"></i>Refer a friend</a>
                        </li>
                    @endif
    ...
    <div class="container px-0">
        <div class="menu-list">
            <ul>
                ...
                @if(Common::has_permission(auth()->id(),'manage_store'))
                    <li class="<?= isset($menu) && ($menu == 'shop') ? 'active' : '' ?>">
                        <a href="{{url('/stores')}}"><i class="fa fa-cart-plus" aria-hidden="true"></i>Shop</a>
                    </li>
                @endif
