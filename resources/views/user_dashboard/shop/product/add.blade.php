                ...
                <div class="col-md-9 col-xs-12 mb20 marginTopPlus">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form method="post" action="{{ url('products/store') }}" id="create_product_form" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="product_code" id="product_code" value="{{ substr(strtoupper(md5(time())), 0, 5) }}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <label id="product_category_id-error" class="error" for="product_category_id"></label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="price" id="price" value="{{ old('price') }}" placeholder="0.00" onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')">
                                                @if($errors->has('price'))
                                                    <span class="error">
                                                        {{ $errors->first('price') }}
                                                    </span>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input class="form-control" name="stock" id="stock" value="{{ old('stock') }}" placeholder="0" onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')">
                                                @if($errors->has('stock'))
                                                    <span class="error">
                                                        {{ $errors->first('stock') }}
                                                    </span>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <button type="submit" class="btn btn-cust pull-right" id="create_product">
                                                    <i class="spinner fa fa-spinner fa-spin" style="display: none;"></i> <span id="create_product_text">Add</span>
                                                </button>
                                            </div>
                                        </div>
                                    </form>
    ...
    */
    ...
    $('#create_product_form').validate({
        ...
        submitHandler: function(form)
        {
            ...
            $(".spinner").show();
            $("#create_product_text").text('Adding . . .');
            $('#create_product').click(false);
            form.submit();
        }
    });
    ...
    $(document).ready(function() {
        $("#product_code").on('input', function(e) {
            ...
            $.ajax({
                ...
                method: "POST",
                url: SITE_URL + "/products/product-code-check",
                dataType: "json",
                data: {
