				...
				<tr>
					<td>
						...
						<table style="margin-top:20px; width:300px;">
							...
							<tr>
								<td style="font-size:15px; color:#000000;">Order Payment Amount</td>
			...
			<table>
				<tr>
					<td>
						<table>
							<tr>
								<td style="font-size: 16px; color:#000000; line-height:25px; font-weight:bold;">Paid By</td>
							</tr>
							<tr>
								<td style="font-size:15px; color:#4e5c6e; line-height:22px;">
									{{ @$transactionDetails->end_user->first_name }}&nbsp;{{ @$transactionDetails->end_user->last_name}}
				...
				<tr>
					<td>
						<table style="margin-top:20px; width:300px;">
							...
							<tr>
								<td style="font-size:15px; color:#000000;">Order Received Amount</td>
