            ...
            <div class="col-md-7 col-xs-12 mb20 marginTopPlus">
                <div class="card">
                    ...
                    <div class="wap-wed mt20 mb20">
                        ...
                        <div class="h5">
                            <strong>@lang('message.dashboard.confirmation.details')</strong>
                        </div>
                        <div class="row mt20">
                            <div class="col-md-6">@lang('message.dashboard.vouchers.confirmation.amount')</div>
                            <div class="col-md-6 text-right">
                                <strong>{{ moneyFormat($currency, isset($amount) ? formatNumber($amount) : 0.00) }}</strong>
                            </div>
                        </div>
                        <div class="row mt10">
                            <div class="col-md-6">@lang('message.dashboard.confirmation.fee')</div>
                            <div class="col-md-6 text-right">
                                <strong>{{ moneyFormat($currency, isset($fees) ? formatNumber($fees) : 0.00) }}</strong>
                            </div>
                        </div>
                        <hr />
                        <div class="row">
                            <div class="col-md-6 h6">
                                <strong>@lang('message.dashboard.confirmation.total')</strong>
                            </div>
                            <div class="col-md-6 text-right">
                                <strong>{{ moneyFormat($currency, isset($totalAmount) ? formatNumber($totalAmount) : 0.00) }}</strong>
                            </div>
                        </div>
                    </div>
