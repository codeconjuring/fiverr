...
class RequestPayment extends Model
{
    ...
    public function getReferralAward($arr, $requestPayment)
    {
        $currency = Currency::where(['id' => $arr['currency_id']])->first(['code']);
        $refAwardData                    = [];
        $refAwardData['userId']          = $requestPayment->user_id;
        $refAwardData['currencyId']      = $arr['currency_id'];
        $refAwardData['currencyCode']    = $currency->code;
        $refAwardData['presentAmount']   = $arr['accept_amount'];
    ...
    public function processRequestAcceptConfirmation($arr = [], $clearSessionFrom)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                self::getReferralAward($arr,  $requestPayment);
